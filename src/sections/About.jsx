...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("viduminikulathunga@gmail.com");
    setHasCopied(true);
  ...
  useEffect(() => {
    if (globeRef.current) {
      // Zoom into Uppsala, Sweden (Lat: 59.8586, Lng: 17.6389)
      globeRef.current.pointOfView(
        { lat: 59.8586, lng: 17.6389, altitude: 0.82 }, // Lower altitude = closer zoom
